...
CREATE TABLE Music (mid int, asin int,
price int,
name text,
puid int NOT NULL,
PRIMARY KEY (mid),
FOREIGN KEY (puid) REFERENCES Production_Company);
...
FOREIGN KEY (comment_id) REFERENCES User_Comments) ;
...
CREATE TABLE BELONGS_TO (guid int, 
mid int, 
